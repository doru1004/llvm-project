...
// RUN: %clang_cc1 -fopenmp -fopenmp-targets=x86_64-apple-macos10.7.0 -fopenmp-version=52 -DVERBOSE_MODE=1 -verify=expected,omp52 -fnoopenmp-use-tls -ferror-limit 100 -o - %s
